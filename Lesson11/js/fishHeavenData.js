const apiURL =
  "https://api.openweathermap.org/data/2.5/weather?id=5585000&appid=06b6331ef13b0a99c294a19279a4add5&units=imperial";
fetch(apiURL)
...
const forecastURL =
  "https://api.openweathermap.org/data/2.5/forecast?id=5585000&appid=06b6331ef13b0a99c294a19279a4add5&units=imperial";
fetch(forecastURL)
  .then((response) => response.json())
  .then((forecastInfo) => {
